...
//ADD NEW ITEMS
if (typeOf _supp == var_e_supSmall) exitWith {
...
if (typeOf _supp == var_e_supLarge) exitWith {
...
if (typeOf _supp == var_e_supSpecial) exitWith {
...
if (typeOf _supp == var_e_supExplosives) exitWith {
