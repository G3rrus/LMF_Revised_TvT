...
//ADD NEW ITEMS
if (typeOf _supp == var_i_supSmall) exitWith {
...
if (typeOf _supp == var_i_supLarge) exitWith {
...
if (typeOf _supp == var_i_supSpecial) exitWith {
...
if (typeOf _supp == var_i_supExplosives) exitWith {
