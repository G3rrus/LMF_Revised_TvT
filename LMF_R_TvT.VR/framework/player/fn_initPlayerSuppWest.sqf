...
//ADD NEW ITEMS
if (typeOf _supp == var_w_supSmall) exitWith {
...
if (typeOf _supp == var_w_supLarge) exitWith {
...
if (typeOf _supp == var_w_supSpecial) exitWith {
...
if (typeOf _supp == var_w_supExplosives) exitWith {
